...
class GraphicOverlay(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
     ...
     * this and implement the [draw] method to define the graphics element. Add
     * instances to the overlay using [add].
     */
    abstract class Graphic(private val overlay: GraphicOverlay) {
         ...
         * 
         * 
         *  1. [scale] adjusts the size of the supplied value from the image
         * scale to the view scale.
         *  1. [translateX] and [translateY] adjust the
         * coordinate from the image's coordinate system to the view coordinate system.
         * 
         * 
