...
@Database(entities = [Vehicle::class, GasReading::class, DetectionSample::class], version = 10, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {
    abstract fun gasReadingDao(): GasReadingDao
    abstract fun vehicleDao(): VehicleDao
    abstract fun detectionSampleDao(): DetectionSampleDao
    ...
    companion object {
        ...
        private val MIGRATION_8_9 = object : Migration(8, 9) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE `vehicles` ADD COLUMN `tankLiters` REAL NOT NULL DEFAULT 5.5")
            }
        }
